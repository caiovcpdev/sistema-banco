...
begin
  ...
  fBanco.vPuCSProvedor       := 'Provider=SQLOLEDB.1;Password=rec235net896sim;Persist Security Info=True;User ID=matrix;Initial Catalog=Recursos_Matrix;Data Source=grprodev,1433';
